...
#ifdef BUTTONREVERSE
    #define L1 Controller1.ButtonR1.pressing()
    #define L2 Controller1.ButtonR2.pressing()
    #define R1 Controller1.ButtonL1.pressing()
    #define R2 Controller1.ButtonL2.pressing()
#endif
